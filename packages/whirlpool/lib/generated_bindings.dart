...
class NativeLibrary {
  ...
  ffi.Pointer<WhirlpoolClient> whirlpool_start() {
    return _whirlpool_start();
  }

  late final _whirlpool_startPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<WhirlpoolClient> Function()>>(
          'whirlpool_start');
  late final _whirlpool_start =
      _whirlpool_startPtr.asFunction<ffi.Pointer<WhirlpoolClient> Function()>();

  void whirlpool_stop(
    ffi.Pointer<WhirlpoolClient> whirlpool,
  ) {
    return _whirlpool_stop(
      whirlpool,
    );
  }

  late final _whirlpool_stopPtr = _lookup<
          ffi.NativeFunction<ffi.Void Function(ffi.Pointer<WhirlpoolClient>)>>(
      'whirlpool_stop');
  late final _whirlpool_stop = _whirlpool_stopPtr
      .asFunction<void Function(ffi.Pointer<WhirlpoolClient>)>();
}

class WhirlpoolClient extends ffi.Opaque {}
